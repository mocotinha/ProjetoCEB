...
/*		Connection conection = DriverManager.getConnection("jdbc:postgresql://localhost:5432/","postgres","jozias123");
		Statement statement = conection.createStatement();
		statement.executeUpdate("IF NOT EXIST");*/
		getManager();
	}
	...
	protected static EntityManager getManager(){
		if(manager==null){
			EntityManagerFactory factory = 
				Persistence.createEntityManagerFactory("ceb");
